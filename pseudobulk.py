...
def main():
    parser = argparse.ArgumentParser(description='Run pseudobulk peak calling')
    
    # Required arguments
    parser.add_argument('--ctrl_fragments', required=True, help='Path to Control fragments file')
    parser.add_argument('--trt_fragments', required=True, help='Path to Treatment fragments file')
    parser.add_argument('--chrom_sizes', required=True, help='Path to chrom.sizes file')
    
    # Optional arguments with defaults
    parser.add_argument('--ctrl_name', default='Control', help='Control sample name (default: Control)')
    parser.add_argument('--trt_name', default='Treatment', help='Treatment sample name (default: Treatment)')
    parser.add_argument('--out_dir', default='scenicOuts', help='Output directory (default: scenicOuts)')
    parser.add_argument('--n_cpu', type=int, default=4, help='Number of CPUs (default: 4)')
    parser.add_argument('--normalize_bigwig', action='store_true', default=True, help='Normalize BigWig files (default: True)')
    parser.add_argument('--temp_dir', default='/tmp', help='Temporary directory (default: /tmp)')
    ...
    # -----------------------------
    fragments_dict = {
        args.ctrl_name: args.ctrl_fragments,
        args.trt_name: args.trt_fragments
    }
